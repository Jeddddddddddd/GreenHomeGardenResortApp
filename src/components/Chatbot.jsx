      ...
      {open && (
        ...
        >
          ...
          <div style={{ 
            ...
            <h4 style={{ margin: 0, color: "#00e676", letterSpacing: "1px", textTransform: "uppercase", fontSize: "12px" }}>
              Resort Assistant
            </h4>
          </div>
          ...
          {/* Input Area */}
          <div style={{ padding: "20px", display: "flex", gap: "10px", backgroundColor: "rgba(0,0,0,0.2)" }}>
            <input
              value={input}
